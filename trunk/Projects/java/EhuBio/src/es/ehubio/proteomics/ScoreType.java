...
public enum ScoreType {	
	...
	MQ_VALUE(null,"protein-level Mq value","Expected number of randon matching peptides",false),
	...
	LPG_SCORE(null,"protein group-level LPG score","Sum of LPQcorr scores of the proteins in the group",true);
